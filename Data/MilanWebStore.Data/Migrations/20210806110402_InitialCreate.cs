        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ParentCateogryId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParentChildCategories_ChildCategories_ChildCategoryId",
                        column: x => x.ChildCategoryId,
                        principalTable: "ChildCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ParentChildCategories_ParentCategories_ParentCateogryId",
                        column: x => x.ParentCateogryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InDiscount = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSizeAvailable = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChildCategories_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParentCategories_IsDeleted",
                table: "ParentCategories",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ParentChildCategories_ChildCategoryId",
                table: "ParentChildCategories",
                column: "ChildCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ParentChildCategories_ParentCateogryId",
                table: "ParentChildCategories",
                column: "ParentCateogryId");
